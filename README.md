...
<p align="center"><strong>Зажми клавишу и скажи фразу — она сама встанет в текст.</strong></p>
...
**Автовставку можно выключить одной галочкой** — тогда текст только ложится в буфер, и ты вставляешь его сам, когда решишь. Это единственный переключатель, который меняет главное поведение программы, поэтому он лежит первым в настройках.
...
|---|---|---|
| **Облако Groq** *(по умолчанию)* | Всем, кто хочет просто работать | Бесплатный ключ. Лимитов хватает на повседневную диктовку с запасом |
...
| **Трей и автозапуск** | Поднимается вместе с Windows сразу в трей. Второй ярлык не плодит второй процесс |
...
Speecher бесплатный. Его делает один человек в свободное время, здесь раздаются готовые сборки, исходный код не публикуется. Все права на программу принадлежат автору.

**Можно:** пользоваться программой и ставить её на свои компьютеры.

**Нельзя:** перепродавать, распространять изменённые сборки, вскрывать и разбирать программу.

Программа поставляется «как есть», без каких-либо гарантий. Автор не отвечает за возможные убытки от её использования и не обязан выпускать обновления, чинить ошибки или отвечать на обращения — всё это делается по возможности и по желанию.

Сторонние сервисы распознавания подключаешь ты сам и пользуешься ими на их условиях — их работа, тарифы и доступность от меня не зависят.
